...
const _excluded$1l = ["children", "href", "shape", "size", "variant", "color", "startIcon", "endIcon", "wide", "fullWidth", "responsive", "animation", "loading", "active", "disabled", "dataTheme", "className", "style"];
const Button = /*#__PURE__*/forwardRef((_ref, ref) => {
  ...
  if (href) {
    ...
    return jsxs("button", _extends({}, props, {
      ref: ref,
...
const _excluded$1h = ["children", "className", "item", "horizontal", "vertical", "end", "hover", "open", "dataTheme"];
...
const _excluded$18 = ["children", "variant", "outline", "size", "color", "responsive", "dataTheme", "className"];
...
const _excluded$v = ["children", "demo", "size", "horizontal", "dataTheme", "className"];
...
const _excluded$t = ["children", "vertical", "horizontal", "dataTheme", "className"];
const Divider = _ref => {
  let {
      children,
      vertical,
